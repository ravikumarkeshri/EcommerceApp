...
import { ChevronDownIcon, FunnelIcon, MinusIcon, PlusIcon, Squares2X2Icon, ChevronRightIcon, ChevronLeftIcon, StarIcon } from '@heroicons/react/20/solid'
                                                            ...
                                                            <div className="mt-4 flex justify-between">
                                                                <div>
                                                                    ...
                                                                    <div className='flex flex-row gap-3 justify-start items-center'>
                                                                        <StarIcon color='yellow' height={17} width={17} />
