        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
                <div className='lg:col-span-3'>
                    <form action="" className='px-4 bg-white'>
                ...
                <div className='lg:col-span-2'>
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-12 border-[1px] border-gray-400">

                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <h2 className='text-center text-4xl font bold mb-5'>Cart</h2>
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                ...
                                                <div className="flex flex-1 items-end justify-between text-sm">
                                                    <div className="text-gray-500">
                                                        ...
                                                        <select className='scale-75' name="" id="">
